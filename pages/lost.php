...
if (count($items) > 0) {
    ...
    $items_html = '<div style="text-align:center;width:100%;padding:2rem;"><p>No lost items found.</p></div>';
}

// Load the template
$template = file_get_contents('../templates/lost.html');

// Replace placeholder with content
$template = str_replace('<!-- LOST_ITEMS_CONTENT -->', $items_html, $template);
